  ...
  return [
    {
      ...
      keywords: ['anthropic', 'claude', 'sonnet', 'opus', 'haiku', 'claude code'],
      enabled: true,
    },
    {
      id: 'openai',
      name: 'OpenAI',
      keywords: ['openai', 'gpt', 'chatgpt', 'dall-e', 'sora', 'o1', 'o3', 'o4', 'codex', 'whisper', 'openai codex'],
      enabled: true,
    },
    {
      id: 'google',
      name: 'Google',
      keywords: ['google', 'gemini', 'gemma', 'deepmind', 'bard', 'vertex', 'google ai studio', 'veo', 'imagen'],
      enabled: true,
    },
    {
      id: 'aws',
      name: 'AWS',
      keywords: ['aws', 'amazon', 'bedrock', 'sagemaker', 'titan', 'amazon q'],
      enabled: true,
    },
    {
      id: 'meta-ai',
      name: 'Meta AI',
      keywords: ['meta ai', 'llama', 'meta llama', 'codellama'],
      enabled: true,
    },
    {
